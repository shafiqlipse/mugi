...
urlpatterns = [
    ...
    path("delete_trainee/<int:id>", trainee_delete, name="delete_trainee"),
        ...
        path("delete_itrainee/<int:id>", itrainee_delete, name="delete_itrainee"),
        path("update_itrainee/<int:id>", itrainee_update, name="update_itrainee"),
    path("activate_trainee/<int:id>", activate_trainee, name="activate_trainee"),
    path("activate_itrainee/<int:id>", activate_itrainee, name="activate_itrainee"),
