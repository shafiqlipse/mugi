    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_number', models.CharField(max_length=255, unique=True, validators=[school.models.validate_index_number])),
                ('date_of_birth', models.DateField()),
                ('gender', models.CharField(choices=[('Male', 'male'), ('Female', 'female')], max_length=10)),
                ('photo', models.ImageField(upload_to='athlete_photos/')),
                ('ple_certificate', models.ImageField(upload_to='certificates/')),
                ('uce_certificate', models.ImageField(blank=True, null=True, upload_to='certificates/')),
